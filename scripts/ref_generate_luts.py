...
from main_woodscape import collect_tupperware
...
def get_intrinsics(args):
    ...
    for idx, (index_values, cam_side) in enumerate(zip(indicies, camera_sides)):
        ...
        cam_intrinsics[idx].insert(len(cam_intrinsics[idx]), cam_side)
...
def inverse_poly_lut(args, intrinsics, cropped_coords):
    ...
    for intrinsic in tqdm(intrinsics):
        ...
        for i, _r in enumerate(r):
            a = np.roots([D[3], D[2], D[1], D[0], -_r[0]])
...
if __name__ == "__main__":
    ...
    # cropped_coords = dict(Car1=dict(FV=(114, 0, 1176, 610),
    #                                 MVL=(343, 5, 1088, 411),
    #                                 MVR=(185, 5, 915, 425),
    #                                 RV=(186, 0, 1105, 630)),
    #                       Car2=dict(FV=(160, 0, 1030, 677),
    #                                 MVL=(327, 7, 1096, 410),
    #                                 MVR=(175, 4, 935, 404),
    #                                 RV=(285, 0, 1000, 572)))
    
    cropped_coords = dict(Car1=dict(FV=(0, 0, 1280, 966),
                                    MVL=(0, 0, 1280, 966),
                                    MVR=(0, 0, 1280, 966),
                                    RV=(0, 0, 1280, 720)),
                          Car2=dict(FV=(0, 0, 1280, 966),
                                    MVL=(0, 0, 1280, 966),
                                    MVR=(0, 0, 1280, 966),
                                    RV=(0, 0, 1280, 720)))
    ...
    with open('LUTs_ncdb_640x384.pkl', 'wb') as f:
