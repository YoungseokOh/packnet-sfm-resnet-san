...
if __name__ == "__main__":
    input_directory = "/workspace/packnet-sfm/ncdb-cls/synced_data/image_a6/"
    # For in-place replacement, output_directory is the same as input_directory
    output_directory = "/workspace/packnet-sfm/ncdb-cls/synced_data/image_a6/"
    ...
    original_png_count = len(list(Path("/workspace/packnet-sfm/ncdb-cls/synced_data/image_a6_png_backup/").glob('**/*.png')))
